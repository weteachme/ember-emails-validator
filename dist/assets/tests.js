...
define('dummy/tests/unit/validators/emails-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('validator:emails', 'Unit | Validator | emails', {
    needs: ['validator:messages']
  });

  (0, _emberQunit.test)('return true when the emails are valid', function (assert) {
    var result;
    var validator = this.subject();
    result = validator.validate('test@test.com, email@domain.com, firstname.lastname@domain.com');
    assert.equal(result, true);
  });
  (0, _emberQunit.test)('return false when the emails are invalid', function (assert) {
    var result;
    var validator = this.subject();
...
define('dummy/tests/unit/validators/emails-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | unit/validators/emails-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/validators/emails-test.js should pass jshint.');
  });
});
/* jshint ignore:start */
